...
function App() {
    ...
    //gera imagem para download
    function handleGenerateQrCode(qrCodeUrl) {
    ...
    //gera qrcode pegando valor do input
    function handleQrCode(event) {
        setUrl(event.target.value);
        handleGenerateQrCode(event.target.value);
    }

    return (
        <div className="container">
            <h1>Gerador de QR Code<span>.</span></h1>
            ...
            <div className="input-container">
                ...
                <a
                    className={!url ? "button disabled" : "button"}
                    href={qrCodeLink}
                    download={`qrcode.png`}
                    aria-disabled={!url}
                >
            ...
            <footer>
                ...
                <a
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="22" height="22" viewBox="0 0 16 16"fill="#FFFFFF">
